...
<body>
 ...
 <div class="container">
    ...
    <div class="row">
        <div class="col"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tampil">
  tambah
</button></div> 
        <div class="col">
        <form action="<?= base_url('index.php/test/search') ?>" method="get">
...
<!-- Modal -->
<div class="modal fade" id="tampil" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
